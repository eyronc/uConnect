    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-outline-full {
          width: 100%; height: 52px; background: transparent; color: #1a1510;
          font-family: 'DM Sans', sans-serif; font-weight: 600; font-size: 0.8rem;
          letter-spacing: 0.07em; text-transform: uppercase; border: 1.5px solid #c8c2bb; cursor: pointer;
          display: flex; align-items: center; justify-content: center; gap: 0.5rem;
        ...
        .divider-line { flex: 1; height: 1px; background: #ddd8d0; }
        .divider-text { font-size: 0.72rem; color: #b0aba5; letter-spacing: 0.08em; text-transform: uppercase; }
      ...
      <div className="auth-left">
        <div className="auth-vid-bg">
          <video autoPlay muted loop playsInline preload="auto">
            <source src="https://assets.mixkit.co/videos/4519/4519-720.mp4" type="video/mp4" />
            <source src="https://assets.mixkit.co/videos/4520/4520-720.mp4" type="video/mp4" />
          </video>
        </div>
        ...
        <div style={{ maxWidth: 400, width: '100%', margin: '0 auto' }}>
          ...
          <div className="a1" style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ fontSize: '0.875rem', color: '#7a756f' }}>
              ...
              <a href="/register" onClick={(e) => handleNavTo('/register', e)}
